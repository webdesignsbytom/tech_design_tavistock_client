              ...
              <article className='grid opacity-95 z-30 w-fit -mt-1/2 h-fit px-16 py-8 shadow-xl rounded-lg bg-white overflow-hidden russo-one-regular'>
                ...
                <section className='grid pt-6'>
                  <div className='grid grid-cols-2 gap-4 overflow-hidden bg-white'>
                    ...
                    <div>
                      <button onClick={() => navigateToPage('/contact')} className='w-full h-fit px-4 py-2 font-semibold bg-alt-colour text-white border-2 border-solid border-alt-colour rounded-lg hover:text-alt-colour hover:bg-white duration-300'>
                        Contact
                      </button>
                    </div>
                  </div>
                ...
                <article className='p-6'>
                  ...
                  <div className='grid w-full h-fit'>
                    <button
                      ...
                      className='text-xl font-semibold px-4 py-2 cursor-pointer hover:bg-alt-colour  hover:text-white active:scale-95 text-alt-colour border-solid border-alt-colour border-2 rounded-lg bg-white duration-300'
                    >
                      See projects
                    </button>
                  </div>
