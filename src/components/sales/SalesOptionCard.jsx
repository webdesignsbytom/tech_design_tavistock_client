...
function SalesOptionCard({ type }) {
  ...
  return (
    <div className='grid lg:w-3/4 mx-auto px-4'>
      <section className='grid gap-4 px-2 lg:px-4 py-4 my-4 bg-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg'>
        <div className='grid bg-alt-colour shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg px-2 py-2'>
          <article className='grid grid-flow-col  items-center h-fit overflow-hidden'>
            ...
            <section className='grid justify-end'>
              <div className='lg:p-6 bg-white w-12 h-12 rounded-xl m-1 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]'>
        ...
        <article className='grid '>
          <div className='grid gap-8 bg-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg px-4 py-6 lg:px-8 poppins_base'>
            <div>
